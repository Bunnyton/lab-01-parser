...
set_target_properties(lab-01-parser::lab-01-parser PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/liblab-01-parserd.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS lab-01-parser::lab-01-parser )
list(APPEND _IMPORT_CHECK_FILES_FOR_lab-01-parser::lab-01-parser "${_IMPORT_PREFIX}/lib/liblab-01-parserd.a" )
